...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        ...
        if (!!message.mention && message.mention[0] == '917592969476@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/abhi.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        }
...
if(pattern.test(message.message)){
    ...
    Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {   
        ...
        if(banned !== undefined) return
        if (!!message.mention && message.mention[0] == '917592969476@s.whatsapp.net') {
await message.client.sendMessage(message.jid, fs.readFileSync('./Kaztroserv2/abhi.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, contextInfo: { forwardingScore: 5, isForwarded: true }, quoted : message.data, ptt: true})
        }
        if (!!message.mention && message.mention[0] == Config.MENTION) {
await message.client.sendMessage(message.jid, fs.readFileSync('Kaztroserv2/owner.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SAID, quoted : message.data, ptt: true})
        ...
        var uri = encodeURI(match[1])
const array = ['Sed','Hi','help','2','6','alive','Bot','Cr7','Da','Daa','Football','gif','git','group','Ha','Haa','Hello','help','Hm','Ho','invite','kooi','list','Love','Mm','Oo','owner','pm','Poda','Song','sticker','Video','love','bot','Hai','Hlo','Ok','kannappi','business','ponne','left','demon','abin','sneha','wow','line','ronaldo','love u','love you','vila','umb','sanu','zanu','gawtham','rema']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
